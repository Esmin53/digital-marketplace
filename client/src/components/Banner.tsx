    ...
    <div className='flex-1 h-full flex flex-col-reverse sm:flex-row gap-4 lg:gap-6 '>
        <div className=' flex items-center sm:items-start justify-center flex-col gap-2 md:gap-4 w-full sm:w-fit z-40'>
            ...
            <div className='flex gap-4 xl:gap-6'>
                <Link to='/new-product' className='px-3 h-8  md:h-9 lg:h-10 rounded-full bg-accent-teal shadow-sm text-primary font-smooch sm:text-lg md:text-xl font-semibold flex items-center justify-center'>
                    Start Selling
                </Link>
                <Link to="/products" className='px-3 h-8  md:h-9 lg:h-10 rounded-full border-2 border-accent-teal shadow-sm text-accent-teal flex items-center justify-center gap-1'>
